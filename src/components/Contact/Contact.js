...
import { contactUs } from '../../redux/actions/userAction'
            ...
            <form onSubmit={submitHandler} className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <div className="relative">
                  ...
                  <textarea required id="message" name="message" value={Message} onChange={(e) => setMessage(e.target.value)} className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-yellow-400 focus:bg-white focus:ring-2 focus:ring-yellow-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out" />
                </div>
              </div>
              <div className="p-2 w-full">
